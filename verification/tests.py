...
TESTS = {
    "Basics": [
        ...
        {"input": [2, 4], "answer": [16.76, 30.31], "explanation": [16.76, 30.31]},
    ],
    "Extra": [
        {"input": [1, 3], "answer": [4.71, 15.4], "explanation": [4.71, 15.4]},
        ...
        {"input": [2, 3], "answer": [9.42, 19.54], "explanation": [9.42, 19.54]},
    ]
}
